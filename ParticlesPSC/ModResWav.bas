...
Dim U As Long
Dim k As Long
   ReDim WAVData$(0 To 7)
   For k = 0 To 7
      Select Case k
      Case 0: Sound = LoadResData(101, "WATER")
      Case 1: Sound = LoadResData(102, "HOT")
      Case 2: Sound = LoadResData(103, "SPURT")
      Case 3: Sound = LoadResData(104, "SPRAY")
      Case 4: Sound = LoadResData(105, "WAVY")
      Case 5: Sound = LoadResData(106, "SPIRAL")
      Case 6: Sound = LoadResData(107, "EXPAND")
      Case 7: Sound = LoadResData(108, "WIPER")
      End Select
      U = UBound(Sound()) + 1
      WAVData$(k) = Space$(U)
...
Public Sub Play(Index As Integer)
   ...
   ' Complete play first
   sndPlaySound ByVal WAVData$(Index), SND_NODEFAULT Or SND_MEMORY Or SND_ASYNC Or SND_LOOP
'   DoEvents
End Sub
